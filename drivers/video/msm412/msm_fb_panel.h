...
/* panel class */
typedef enum {
	DISPLAY_LCD = 0,	/* lcd = ebi2/mddi/dsi_cmd */
	DISPLAY_LCDC,		/* lcdc/dsi_video/lvds/dtv */
	DISPLAY_TV,		/* TV Out */
...
struct mipi_panel_info {
	...
	/* Customized DSI register configuration */
	struct mipi_dsi_reg_set *dsi_reg_db;
	uint32 dsi_reg_db_size;
	/* Force leave ultra-low power state */
