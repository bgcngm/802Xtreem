...
/* Broadcom, skip point address alignment */
/* For throughput issue, due to extra add 30 bytes for skb 32bytes aligment, it cause SDIO CMD53 fragment */
#ifndef CONFIG_HTC_IGNORE_SKB_ALIGNMENT
...
dhd_bus_rxctl(struct dhd_bus *bus, uchar *msg, uint msglen)
{
	...
	if (rxlen) {
		...
		//HTC_CSP_START for tz dogbark issue
