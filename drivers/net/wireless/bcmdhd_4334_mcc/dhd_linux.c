...
extern void wl_cfg80211_adj_mira_pm(int is_screen_off);/* 2013-11-26 brcm Add  */
...
#else /* defined(CUSTOMER_HW_ONE) && defined(APSTA_CONCURRENT)*/
		/*
...
#else /* CUSTOMER_HW_ONE */
static int dhd_set_suspend(int value, dhd_pub_t *dhd)
{
#ifdef BCM4329_LOW_POWER
	int ignore_bcmc = 1;
#endif
	int mchan_algo = 0; /*2013-11-26 brcm Add*/
