...
wl_cfgp2p_disable_discovery(struct wl_priv *wl)
{
	s32 ret = BCME_OK;
	CFGP2P_DBG((" enter\n"));
	wl_clr_p2p_status(wl, DISCOVERY_ON); /* penguin, why remove this???? */
...
#define P2PAPI_SCAN_AF_SEARCH_DWELL_TIME_MS 100
	...
	memset(&ssid, 0, sizeof(ssid)); /* BRCM TBD */
