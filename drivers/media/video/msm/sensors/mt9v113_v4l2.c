...
static int mt9v113_set_sharpness(enum sharpness_mode sharpness_value)
{
	...
	rc = mt9v113_i2c_write(mt9v113_client->addr, 0x098C, 0xAB22, WORD_LEN);
	rc = mt9v113_i2c_write(mt9v113_client->addr, 0x0990, 0x0005, WORD_LEN);//mu l 1005 with face beauty 0x0003
	rc = mt9v113_i2c_write(mt9v113_client->addr, 0x326C, 0x0B00, WORD_LEN);//mu l 1005 with face beauty 0x0900
			if (rc < 0)
				return -EIO;
	...
	rc = mt9v113_i2c_write(mt9v113_client->addr, 0x098C, 0xAB22, WORD_LEN);
	rc = mt9v113_i2c_write(mt9v113_client->addr, 0x0990, 0x0006, WORD_LEN); //mu l 1005 with face beauty 0x0005
