...
unsigned mmc_sd_get_max_clock(struct mmc_card *card)
{
	...
	/*
	 * Fix the issue that host does not supports high speed,
	 * or fail to switch to high speed mode, but max frequency of card
	 * is larger than 25MHz. Then we can not set clock to the frequency
	 *  larger than 25MHz. Therefore, we limit it to 25MHz.
	*/
