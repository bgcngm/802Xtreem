...
#define RCV_SPK_SEL_PMGPIO  24 /* AUD_RECEIVER_SEL (Receiver/Speaker amp selection) */
#define AUD_HP_EN_GPIO      PM8921_GPIO_PM_TO_SYS(37) /* AUD_HP_EN (HP AMP enable, H: Enable) */
