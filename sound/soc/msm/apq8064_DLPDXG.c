...
/* HTC ++ */
#define HAC_PAMP_GPIO        6 /* there is no HAC for DLP#China, keep the code */
#define RCV_PAMP_PMGPIO     33 /* AUD_RECEIVER_EN (Audio Receiver amp enable, H: Enable) */
#define RCV_SPK_SEL_PMGPIO  44 /* AUD_RECEIVER_SEL (Receiver/Speaker amp selection) */
#define AUD_HP_EN_GPIO      57 /* AUD_HP_EN (HP AMP enable, H: Enable) */
...
{
	int ret = 0, rc = 0;
#if 0 /* mark it due to the pin change to apq gpio from pmic gpio */
