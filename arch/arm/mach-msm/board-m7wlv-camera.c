...
static struct msm_gpiomux_config m7wlv_cam_common_configs[] = {
	{
...
struct msm_camera_device_platform_data m7wlv_msm_camera_csi_device_data[] = {
	{
		.ioclk.mclk_clk_rate = 24000000,
		.ioclk.vfe_clk_rate  = 228570000,
		.csid_core = 0,
		.camera_csi_on = m7wlv_csi_vreg_on,
		.camera_csi_off = m7wlv_csi_vreg_off,
...
int m7wlv_flashlight_control(int mode)
{
...
static struct msm_camera_sensor_flash_src msm_camera_flash_src = {
	...
	.camera_flash = m7wlv_flashlight_control,
};
#endif
#endif
...
static int m7wlv_use_ext_1v2(void)
{
	return 1;
}

static int m7wlv_rawchip_vreg_on(void)
{
	int rc;
#if 0
...
static int m7wlv_rawchip_vreg_off(void)
{
	int rc = 0;
#if 0
	int gpio_cam_d1v2_en=0;
...
static struct msm_camera_rawchip_info m7wlv_msm_rawchip_board_info = {
...
struct platform_device m7wl_msm_rawchip_device = {
	.name	= "yushanII",
	.dev	= {
		.platform_data = &m7wlv_msm_rawchip_board_info,
	},
};
#endif
...
static void m7wlv_yushanii_probed(enum htc_camera_image_type_board htc_image)
{
...
static int m7wlv_imx175_vreg_off(void)
{
	int rc = 0;
	unsigned gpio_cam_d1v2_en = 0;
...
static struct msm_camera_sensor_info msm_camera_sensor_imx175_data = {
	.sensor_name	= "imx175",
	.camera_power_on = m7wlv_imx175_vreg_on,
	.camera_power_off = m7wlv_imx175_vreg_off,
	.pdata	= &m7wlv_msm_camera_csi_device_data[0],
...
#ifdef CONFIG_IMX135
static int m7wlv_imx135_vreg_on(void)
{
	int rc;
	int gpio_cam_d1v2_en=0;
	pr_info("%s\n", __func__);
...
static int m7wlv_imx135_vreg_off(void)
{
	int rc = 0;
	int gpio_cam_d1v2_en=0;
	pr_info("%s\n", __func__);
...
static struct msm_camera_sensor_info msm_camera_sensor_imx135_data = {
	.sensor_name	= "imx135",
	.camera_power_on = m7wlv_imx135_vreg_on,
	.camera_power_off = m7wlv_imx135_vreg_off,
	.camera_yushanii_probed = m7wlv_yushanii_probed,
	.pdata	= &m7wlv_msm_camera_csi_device_data[0],
...
static int m7wlv_vd6869_vreg_off(void)
{
	int rc = 0;
	int gpio_cam_d1v2_en=0;
	pr_info("%s\n", __func__);
...
static struct msm_camera_sensor_info msm_camera_sensor_vd6869_data = {
	.sensor_name	= "vd6869",
	.camera_power_on = m7wlv_vd6869_vreg_on,
	.camera_power_off = m7wlv_vd6869_vreg_off,
	.camera_yushanii_probed = m7wlv_yushanii_probed,
	.pdata	= &m7wlv_msm_camera_csi_device_data[0],
...
//static 
int m7_ov4688_vreg_on(void)
{
    return m7wlv_vd6869_vreg_on();	
}

//static 
int m7_ov4688_vreg_off(void)
{
    return m7wlv_vd6869_vreg_off();
}
...
static int m7wlv_imx091_vreg_off(void)
{
	int rc = 0;
...
static struct msm_camera_sensor_info msm_camera_sensor_imx091_data = {
	.sensor_name	= "imx091",
	.camera_power_on = m7wlv_imx091_vreg_on,
	.camera_power_off = m7wlv_imx091_vreg_off,
	.pdata	= &m7wlv_msm_camera_csi_device_data[0],
...
static int m7wlv_s5k3h2yx_vreg_on(void)
{
	int rc;
	pr_info("%s\n", __func__);
...
static int m7wlv_s5k3h2yx_vreg_off(void)
{
	int rc = 0;
...
static struct msm_camera_sensor_info msm_camera_sensor_s5k3h2yx_data = {
	...
	.camera_power_on = m7wlv_s5k3h2yx_vreg_on,
	.camera_power_off = m7wlv_s5k3h2yx_vreg_off,
	.pdata	= &m7wlv_msm_camera_csi_device_data[0],
...
static int m7wlv_s5k6a1gx_vreg_off(void)
{
	int rc;
	pr_info("%s\n", __func__);
...
static struct msm_camera_sensor_info msm_camera_sensor_s5k6a1gx_data = {
	...
	.vcm_pwd	= 0,
	.vcm_enable	= 0,
	.camera_power_on = m7wlv_s5k6a1gx_vreg_on,
	.camera_power_off = m7wlv_s5k6a1gx_vreg_off,
	.pdata	= &m7wlv_msm_camera_csi_device_data[1],
...
static int m7wlv_ar0260_vreg_off(void)
{
	int rc = 0;
	pr_info("%s\n", __func__);
...
static struct msm_camera_sensor_info msm_camera_sensor_ar0260_data = {
	...
	.vcm_pwd	= 0,
	.vcm_enable	= 0,
	.camera_power_on = m7wlv_ar0260_vreg_on,
	.camera_power_off = m7wlv_ar0260_vreg_off,
	.camera_yushanii_probed = m7wlv_yushanii_probed,
#ifdef CONFIG_CAMERA_IMAGE_NONE_BOARD
	.pdata	= &m7wlv_msm_camera_csi_device_data[1],
#else
...
#ifdef CONFIG_OV2722
static int m7wlv_ov2722_vreg_on(void)
{
	int rc;
	pr_info("%s\n", __func__);
...
static int m7wlv_ov2722_vreg_off(void)
{
	int rc = 0;
	pr_info("%s\n", __func__);
...
static struct msm_camera_sensor_info msm_camera_sensor_ov2722_data = {
	...
	.vcm_pwd	= 0,
	.vcm_enable	= 0,
	.camera_power_on = m7wlv_ov2722_vreg_on,
	.camera_power_off = m7wlv_ov2722_vreg_off,
	.camera_yushanii_probed = m7wlv_yushanii_probed,
#ifdef CONFIG_CAMERA_IMAGE_NONE_BOARD
	.pdata	= &m7wlv_msm_camera_csi_device_data[1],
#else
...
#ifdef CONFIG_I2C
static struct i2c_board_info m7wlv_camera_i2c_boardinfo_imx135_ar0260[] = {
#ifdef CONFIG_IMX135
		{
...
static struct i2c_board_info m7wlv_camera_i2c_boardinfo_imx135_ov2722[] = {
#ifdef CONFIG_IMX135
		{
		I2C_BOARD_INFO("imx135", 0x20 >> 1),
		.platform_data = &msm_camera_sensor_imx135_data,
...
static struct i2c_board_info m7wlv_camera_i2c_boardinfo_vd6869_ar0260[] = {
#ifdef CONFIG_VD6869
		{
...
static struct i2c_board_info m7wlv_camera_i2c_boardinfo_vd6869_ov2722[] = {
#ifdef CONFIG_VD6869
		{
		I2C_BOARD_INFO("vd6869", 0x20 >> 1),
		.platform_data = &msm_camera_sensor_vd6869_data,
...
int m7wlv_front_camera_id(void)
{
	int rc = 0;
...
void m7wlv_vcm_vreg_on(void)
{
	...
	rc = m7wlv_rawchip_vreg_on();
	if (rc < 0) {
		pr_err("%s m7wlv_rawchip_vreg_on failed\n", __func__);
		return;
	}
...
void __init m7wl_init_cam(void)
{
	...
	pr_info("%s", __func__);
	msm_gpiomux_install(m7wlv_cam_common_configs,
			ARRAY_SIZE(m7wlv_cam_common_configs));
	...
	main_camera_id = m7wlv_main_camera_id();
	front_camera_id = m7wlv_front_camera_id();
	...
	if (main_camera_id == CAMERA_SENSOR_ID_ST_4M) {
		if (front_camera_id == CAMERA_SENSOR_ID_AR0260_2M) {
			i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
				m7wlv_camera_i2c_boardinfo_vd6869_ar0260,
				ARRAY_SIZE(m7wlv_camera_i2c_boardinfo_vd6869_ar0260));
		} else {
			i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
				m7wlv_camera_i2c_boardinfo_vd6869_ov2722,
				ARRAY_SIZE(m7wlv_camera_i2c_boardinfo_vd6869_ov2722));
		}
		...
		if (front_camera_id == CAMERA_SENSOR_ID_AR0260_2M) {
			...
			msm_camera_sensor_ar0260_data.pdata = &m7wlv_msm_camera_csi_device_data[1];

			i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
				m7wlv_camera_i2c_boardinfo_imx135_ar0260,
				ARRAY_SIZE(m7wlv_camera_i2c_boardinfo_imx135_ar0260));
		}else{

			msm_camera_sensor_ov2722_data.pdata = &m7wlv_msm_camera_csi_device_data[1];

			i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
				m7wlv_camera_i2c_boardinfo_imx135_ov2722,
				ARRAY_SIZE(m7wlv_camera_i2c_boardinfo_imx135_ov2722));
		}
