...
static struct msm_camera_rawchip_info zara_cl_msm_rawchip_board_info = {
...
struct platform_device zara_cl_msm_rawchip_device = {
	.name	= "rawchip",
	.dev	= {
		.platform_data = &zara_cl_msm_rawchip_board_info,
	},
};
#endif
...
void __init zara_cl_init_cam(void)
{
...
struct msm_camera_board_info zara_cl_camera_board_info_XA = {
	.board_info = zara_camera_i2c_boardinfo_XA,
	.num_i2c_board_info = ARRAY_SIZE(zara_camera_i2c_boardinfo_XA),
};

struct msm_camera_board_info zara_cl_camera_board_info_XB = {
