...
#endif
#include <mach/ncp6924.h>	/* HTC_START steven 20130709 use i2c control NCP6924 PMIC*/
...
//sstatic struct regulator *reg_8038_l8;	/* V_CAM_A2V8 */
...
/* HTC_START steven 20130709 use i2c control NCP6924 PMIC*/
...
/* HTC_END steven 20130709 use i2c control NCP6924 PMIC*/

static struct msm_camera_rawchip_info cp5_wl_msm_rawchip_board_info = {
...
struct platform_device cp5_wl_msm_rawchip_device = {
	.name	= "rawchip",
	.dev	= {
		.platform_data = &cp5_wl_msm_rawchip_board_info,
	},
};
#endif
...
static int msm8930_mt9v113_vreg_on(void)
{
	...
	/* VCM */
	/* camera vcm 2.8V power */
	/* turn off NCP6924_ID_LDO2*/
	...
	/* analog */
	/* camera analog 2.8V power */
	/* turn on NCP6924_ID_LDO1 */
	...
	/* IO */
	/* camera IO 1.8V power enable*/
	/* turn on NCP6924_ID_LDO3 */
...
void __init cp5_wl_init_cam(void)
{
...
#ifdef CONFIG_I2C
struct i2c_board_info cp5_wl_camera_i2c_boardinfo_XA[] = {
#ifdef CONFIG_OV5693
	{
...
struct i2c_board_info cp5_wl_camera_i2c_boardinfo_XB[] = {
#ifdef CONFIG_OV5693
	{
	I2C_BOARD_INFO("ov5693", 0x20 >> 1),
	.platform_data = &msm_camera_sensor_ov5693_data,
...
struct msm_camera_board_info cp5_wl_camera_board_info_XA = {
	.board_info = cp5_wl_camera_i2c_boardinfo_XA,
	.num_i2c_board_info = ARRAY_SIZE(cp5_wl_camera_i2c_boardinfo_XA),
};

struct msm_camera_board_info cp5_wl_camera_board_info_XB = {
	.board_info = cp5_wl_camera_i2c_boardinfo_XB,
	.num_i2c_board_info = ARRAY_SIZE(cp5_wl_camera_i2c_boardinfo_XB),
};
#endif
