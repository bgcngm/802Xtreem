...
#define CAM_PIN_GPIO_MCAM_D1V2_EN	PM8921_GPIO_PM_TO_SYS(NC_PMGPIO_29) /*Change the GPIO in DLXP_UL*/
...
#define CAM_PIN_GPIO_CAM_MCLK0	RAW_MCLK	/*CAMIF_MCLK*/
#define CAM_PIN_GPIO_CAM_SEL	RAW_RSTz	/*CAMIF_MCLK*/
...
static struct msm_gpiomux_config dlxp_ul_cam_common_configs[] = {
	{
...
static int dlxp_ul_csi_vreg_on(void);
static int dlxp_ul_csi_vreg_off(void);

struct msm_camera_device_platform_data dlxp_ul_msm_camera_csi_device_data[] = {
	{
		.ioclk.mclk_clk_rate = 24000000,
		.ioclk.vfe_clk_rate  = 228570000,
		.csid_core = 0,
		.camera_csi_on = dlxp_ul_csi_vreg_on,
		.camera_csi_off = dlxp_ul_csi_vreg_off,
...
int dlxp_ul_flashlight_control(int mode)
{
...
static struct msm_camera_sensor_flash_src msm_camera_flash_src = {
	...
	.camera_flash = dlxp_ul_flashlight_control,
};
#endif
#endif
...
static int dlxp_ul_use_ext_1v2(void)
{
	return 1;
}

static int dlxp_ul_rawchip_vreg_on(void)
{
	int rc;
...
static int dlxp_ul_rawchip_vreg_off(void)
{
	int rc = 0;
...
static struct msm_camera_rawchip_info dlxp_ul_msm_rawchip_board_info = {
	...
	.camera_rawchip_power_on = dlxp_ul_rawchip_vreg_on,
	.camera_rawchip_power_off = dlxp_ul_rawchip_vreg_off,
	.rawchip_use_ext_1v2 = dlxp_ul_use_ext_1v2,
};

struct platform_device dlxp_ul_msm_rawchip_device = {
	.name	= "yushanII",
	.dev	= {
		.platform_data = &dlxp_ul_msm_rawchip_board_info,
	},
};
#endif
...
static void dlxp_ul_yushanii_probed(enum htc_camera_image_type_board htc_image)
{
...
#ifdef CONFIG_IMX175
static int dlxp_ul_imx175_vreg_on(void)
{
	int rc;
...
static int dlxp_ul_imx175_vreg_off(void)
{
	int rc = 0;
	unsigned gpio_cam_d1v2_en = 0;
...
static struct msm_camera_sensor_info msm_camera_sensor_imx175_data = {
	.sensor_name	= "imx175",
	.camera_power_on = dlxp_ul_imx175_vreg_on,
	.camera_power_off = dlxp_ul_imx175_vreg_off,
	.pdata	= &dlxp_ul_msm_camera_csi_device_data[0],
...
#ifdef CONFIG_IMX135
static int dlxp_ul_imx135_vreg_on(void)
{
	int rc;
...
static int dlxp_ul_imx135_vreg_off(void)
{
	int rc = 0;
	int gpio_cam_d1v2_en=0;
	pr_info("%s\n", __func__);
...
static struct msm_camera_sensor_info msm_camera_sensor_imx135_data = {
	.sensor_name	= "imx135",
	.camera_power_on = dlxp_ul_imx135_vreg_on,
	.camera_power_off = dlxp_ul_imx135_vreg_off,
	.camera_yushanii_probed = dlxp_ul_yushanii_probed,
	.pdata	= &dlxp_ul_msm_camera_csi_device_data[0],
...
#ifdef CONFIG_VD6869
static int dlxp_ul_vd6869_vreg_on(void)
{
	int rc;
...
static int dlxp_ul_vd6869_vreg_off(void)
{
	int rc = 0;
	pr_info("%s\n", __func__);
	...
	/* digital */
	rc = gpio_request(CAM_PIN_GPIO_MCAM_D1V2_EN, "MCAM_D1V2_EN");
	pr_info("%s: CAM_PIN_GPIO_MCAM_D1V2_EN_DLXP_UL off (%d)\n", __func__, rc);
	if (rc < 0)
		pr_err("sensor_power_disable\
			(\"gpio %d\", 1.2V) FAILED %d\n",
			CAM_PIN_GPIO_MCAM_D1V2_EN, rc);
...
static struct msm_camera_sensor_platform_info sensor_vd6869_board_info = {
	...
	.sensor_mount_angle = ANGLE_270, /*HTC chuck*/
...
static struct msm_camera_sensor_info msm_camera_sensor_vd6869_data = {
	.sensor_name	= "vd6869",
	.camera_power_on = dlxp_ul_vd6869_vreg_on,
	.camera_power_off = dlxp_ul_vd6869_vreg_off,
	.camera_yushanii_probed = dlxp_ul_yushanii_probed,
	.pdata	= &dlxp_ul_msm_camera_csi_device_data[0],
...
static int dlxp_ul_ov4688_vreg_on(void)
{
	int rc =0;
	pr_info("%s\n", __func__);
...
static int dlxp_ul_ov4688_vreg_off(void)
{
	int rc = 0;
	pr_info("%s\n", __func__);
...
static struct msm_camera_sensor_info msm_camera_sensor_ov4688_data = {
	.sensor_name	= "ov4688",
	.camera_power_on = dlxp_ul_ov4688_vreg_on,
	.camera_power_off = dlxp_ul_ov4688_vreg_off,
	.camera_yushanii_probed = dlxp_ul_yushanii_probed,
	.pdata	= &dlxp_ul_msm_camera_csi_device_data[0],
...
#endif//end ov4688
#ifdef CONFIG_IMX091
static int dlxp_ul_imx091_vreg_on(void)
{
	int rc;
	pr_info("%s\n", __func__);
...
static int dlxp_ul_imx091_vreg_off(void)
{
	int rc = 0;
...
static struct msm_camera_sensor_info msm_camera_sensor_imx091_data = {
	.sensor_name	= "imx091",
	.camera_power_on = dlxp_ul_imx091_vreg_on,
	.camera_power_off = dlxp_ul_imx091_vreg_off,
	.pdata	= &dlxp_ul_msm_camera_csi_device_data[0],
...
static int dlxp_ul_s5k3h2yx_vreg_on(void)
{
	int rc;
	pr_info("%s\n", __func__);
...
static int dlxp_ul_s5k3h2yx_vreg_off(void)
{
	int rc = 0;
...
static struct msm_camera_sensor_info msm_camera_sensor_s5k3h2yx_data = {
	...
	.camera_power_on = dlxp_ul_s5k3h2yx_vreg_on,
	.camera_power_off = dlxp_ul_s5k3h2yx_vreg_off,
	.pdata	= &dlxp_ul_msm_camera_csi_device_data[0],
...
static int dlxp_ul_s5k6a1gx_vreg_on(void)
{
	int rc;
	pr_info("%s\n", __func__);
...
static int dlxp_ul_s5k6a1gx_vreg_off(void)
{
	int rc;
	pr_info("%s\n", __func__);
...
static struct msm_camera_sensor_info msm_camera_sensor_s5k6a1gx_data = {
	...
	.vcm_pwd	= 0,
	.vcm_enable	= 0,
	.camera_power_on = dlxp_ul_s5k6a1gx_vreg_on,
	.camera_power_off = dlxp_ul_s5k6a1gx_vreg_off,
	.pdata	= &dlxp_ul_msm_camera_csi_device_data[1],
...
#ifdef CONFIG_AR0260
static int dlxp_ul_ar0260_vreg_on(void)
{
	int rc;
...
static int dlxp_ul_ar0260_vreg_off(void)
{
	int rc = 0;
	pr_info("%s\n", __func__);
...
static struct msm_camera_sensor_info msm_camera_sensor_ar0260_data = {
	...
	.vcm_pwd	= 0,
	.vcm_enable	= 0,
	.camera_power_on = dlxp_ul_ar0260_vreg_on,
	.camera_power_off = dlxp_ul_ar0260_vreg_off,
	.camera_yushanii_probed = dlxp_ul_yushanii_probed,
#ifdef CONFIG_CAMERA_IMAGE_NONE_BOARD
	.pdata	= &dlxp_ul_msm_camera_csi_device_data[1],
#else
...
#ifdef CONFIG_OV2722
static int dlxp_ul_ov2722_vreg_on(void)
{
	int rc;
	pr_info("%s\n", __func__);
...
static int dlxp_ul_ov2722_vreg_off(void)
{
	int rc = 0;
	pr_info("%s\n", __func__);
...
static struct msm_camera_sensor_info msm_camera_sensor_ov2722_data = {
	...
	.vcm_pwd	= 0,
	.vcm_enable	= 0,
	.camera_power_on = dlxp_ul_ov2722_vreg_on,
	.camera_power_off = dlxp_ul_ov2722_vreg_off,
	.camera_yushanii_probed = dlxp_ul_yushanii_probed,
#ifdef CONFIG_CAMERA_IMAGE_NONE_BOARD
	.pdata	= &dlxp_ul_msm_camera_csi_device_data[1],
#else
...
#ifdef CONFIG_I2C
static struct i2c_board_info dlxp_ul_camera_i2c_boardinfo_imx135_ar0260[] = {
#ifdef CONFIG_IMX135
		{
...
#if 0
static struct i2c_board_info dlxp_ul_camera_i2c_boardinfo_imx135_ov2722[] = {
#ifdef CONFIG_IMX135
		{
		I2C_BOARD_INFO("imx135", 0x20 >> 1),
		.platform_data = &msm_camera_sensor_imx135_data,
...
#endif
static struct i2c_board_info dlxp_ul_camera_i2c_boardinfo_vd6869_ar0260[] = {
#ifdef CONFIG_VD6869
		{
...
static struct i2c_board_info dlxp_ul_camera_i2c_boardinfo_vd6869_ov2722[] = {
#ifdef CONFIG_VD6869
		{
		I2C_BOARD_INFO("vd6869", 0x20 >> 1),
		.platform_data = &msm_camera_sensor_vd6869_data,
...
struct i2c_board_info dlxp_ul_camera_i2c_boardinfo_ov4688_0x6c_ov2722[] = {
...
struct i2c_board_info dlxp_ul_camera_i2c_boardinfo_ov4688_0x20_ov2722[] = {
...
int dlxp_ul_main_camera_id(void)
{
	int rc = 0;
...
void __init dlxp_ul_init_cam(void)
{
	int main_camera_id = CAMERA_SENSOR_ID_ST_4M;
	int front_camera_id = CAMERA_SENSOR_ID_OV2722_2M;

	pr_info("%s", __func__);
	msm_gpiomux_install(dlxp_ul_cam_common_configs,
			ARRAY_SIZE(dlxp_ul_cam_common_configs));
	...
	main_camera_id = dlxp_ul_main_camera_id();
	...
	if (main_camera_id == CAMERA_SENSOR_ID_ST_4M) {
		...
		i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
			dlxp_ul_camera_i2c_boardinfo_vd6869_ar0260,
			ARRAY_SIZE(dlxp_ul_camera_i2c_boardinfo_vd6869_ar0260));
		} else {
			i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
			dlxp_ul_camera_i2c_boardinfo_vd6869_ov2722,
			ARRAY_SIZE(dlxp_ul_camera_i2c_boardinfo_vd6869_ov2722));
		}
		...
		if(engineerid == 0){/*0x6c (OV4688) will be applied under this rule (engineerid == 0)*/
			i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
			dlxp_ul_camera_i2c_boardinfo_ov4688_0x6c_ov2722,
			ARRAY_SIZE(dlxp_ul_camera_i2c_boardinfo_ov4688_0x6c_ov2722));
		}else{/*0x20 (OV4688) will be applied under this rule (engineerid >= 1)*/
			i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
			dlxp_ul_camera_i2c_boardinfo_ov4688_0x20_ov2722,
			ARRAY_SIZE(dlxp_ul_camera_i2c_boardinfo_ov4688_0x20_ov2722));
		}
		update_yushanII_flag(HTC_CAMERA_IMAGE_YUSHANII_BOARD);
	}
	else {
		msm_camera_sensor_ar0260_data.pdata = &dlxp_ul_msm_camera_csi_device_data[1];
			i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
			dlxp_ul_camera_i2c_boardinfo_imx135_ar0260,
			ARRAY_SIZE(dlxp_ul_camera_i2c_boardinfo_imx135_ar0260));
