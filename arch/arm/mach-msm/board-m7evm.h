...
#define WCN_3V_EN			GPIO(43)
#define AP2MDM_IPC3		GPIO(44)
#define WCN_1V2_EN			GPIO(45)
#define LCM_PWR_EN			GPIO(46)
...
#define AP2QSC_SOFT_RESET		PMGPIO(12)
...
void m7evm_pm8xxx_gpio_mpp_init(void);
