...
/*
PHY define in msm_iomap-8x60.h, VIRT define in msm_iomap-8x60.h
The counters to check kernel exit for both cpu's
kernel foot print for cpu0  		: phy 0x403F3000 : virt 0xFEA00000
kernel foot print for cpu1  		: phy 0x403F3004 : virt 0xFEA00004
kernel foot print for cpu2
kernel foot print for cpu3
kernel exit counter from cpu0		: phy 0x403F3010 : virt 0xFEA00010
kernel exit counter from cpu1		: phy 0x403F3014 : virt 0xFEA00014
kernel exit counter from cpu2
kernel exit counter from cpu3
msm_pm_boot_entry       			: phy 0x403F3020 : virt 0xFEA00020
msm_pm_boot_vector      			: phy 0x403F3024 : virt 0xFEA00024
reset vector for cpu0(init)			: phy 0x403F3028 : virt 0xFEA00028
reset vector for cpu1(init)     	: phy 0x403F302C : virt 0xFEA0002C
reset vector for cpu2(init)
reset vector for cpu3(init)
cpu0 reset vector address			: phy 0x403F3038 : virt 0xFEA00038
cpu1 reset vector address			: phy 0x403F303C : virt 0xFEA0003C
cpu2 reset vector address
cpu3 reset vector address
cpu0 reset vector address value		: phy 0x403F3048 : virt 0xFEA00048
cpu1 reset vector address value		: phy 0x403F304C : virt 0xFEA0004C
cpu2 reset vector address value
cpu3 reset vector address value
cpu0 frequency          			: phy 0x403F3058 : virt 0xFEA00058
cpu1 frequency          			: phy 0x403F305C : virt 0xFEA0005C
cpu2 frequency
cpu3 frequency
L2 frequency						: phy 0x403F3068 : virt 0xFEA00068
acpuclk_set_rate footprint cpu0 	: phy 0x403F306C : virt 0xFEA0006C
acpuclk_set_rate footprint cpu1		: phy 0x403F3070 : virt 0xFEA00070
acpuclk_set_rate footprint cpu2
acpuclk_set_rate footprint cpu3
*/
