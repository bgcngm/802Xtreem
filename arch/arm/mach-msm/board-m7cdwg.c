...
static struct platform_device m7cdwg_android_pmem_device = {
	.name = "android_pmem",
	.id = 0,
...
static struct platform_device m7cdwg_android_pmem_adsp_device = {
	.name = "android_pmem",
	.id = 2,
	.dev = { .platform_data = &android_pmem_adsp_pdata },
};

static struct android_pmem_platform_data m7cdwg_android_pmem_audio_pdata = {
	.name = "pmem_audio",
	.allocator_type = PMEM_ALLOCATORTYPE_BITMAP,
	.cached = 0,
	.memory_type = MEMTYPE_EBI1,
...
static struct msm_rtb_platform_data m7cdwg_rtb_pdata = {
...
static int __init msm_rtb_set_buffer_size(char *p)
{
       ...
       s = memparse(p, NULL);
       m7cdwg_rtb_pdata.size = ALIGN(s, SZ_4K);
       return 0;
}
early_param("msm_rtb_size", msm_rtb_set_buffer_size);


static struct platform_device m7cdwg_rtb_device = {
       .name           = "msm_rtb",
       .id             = -1,
       .dev            = {
               .platform_data = &m7cdwg_rtb_pdata,
       },
};
#endif
...
static int m7cdwg_paddr_to_memtype(unsigned int paddr)
{
	return MEMTYPE_EBI1;
}
...
#ifdef CONFIG_MSM_MULTIMEDIA_USE_ION
static struct ion_cp_heap_pdata cp_mm_m7cdwg_ion_pdata = {
...
static struct ion_cp_heap_pdata cp_mfc_m7cdwg_ion_pdata = {
...
static struct ion_co_heap_pdata co_m7cdwg_ion_pdata = {
	.adjacent_mem_id = INVALID_HEAP_ID,
	.align = PAGE_SIZE,
	.mem_is_fmem = 0,
};

static struct ion_co_heap_pdata fw_co_m7cdwg_ion_pdata = {
...
static struct ion_platform_data ion_pdata = {
	...
	.heaps = {
...
#ifdef CONFIG_MSM_MULTIMEDIA_USE_ION
		{
			...
			.extra_data = (void *) &cp_mm_m7cdwg_ion_pdata,
		},
		{
			...
			.memory_type = ION_EBI_TYPE,
			.extra_data = (void *) &fw_co_m7cdwg_ion_pdata,
		},
		{
			...
			.memory_type = ION_EBI_TYPE,
			.extra_data = (void *) &cp_mfc_m7cdwg_ion_pdata,
		},
#ifndef CONFIG_MSM_IOMMU
		{
			...
			.memory_type = ION_EBI_TYPE,
			.extra_data = (void *) &co_m7cdwg_ion_pdata,
		},
#endif
		{
...
static struct platform_device m7cdwg_ion_dev = {
	.name = "ion-msm",
	.id = 1,
...
static void __init m7cdwg_calculate_reserve_sizes(void)
{
	size_pmem_devices();
	reserve_pmem_memory();
	reserve_ion_memory();
...
static struct reserve_info m7cdwg_reserve_info __initdata = {
	.memtype_reserve_table = apq8064_reserve_table,
	.calculate_reserve_sizes = m7cdwg_calculate_reserve_sizes,
	.reserve_fixed_area = apq8064_reserve_fixed_area,
	.paddr_to_memtype = m7cdwg_paddr_to_memtype,
};

static int m7cdwg_memory_bank_size(void)
{
	return 1<<29;
}
...
static void __init locate_unstable_memory(void)
{
	...
	bank_size = m7cdwg_memory_bank_size();
	...
	m7cdwg_reserve_info.low_unstable_address = mb->start -
					MIN_MEMORY_BLOCK_SIZE + mb->size;
	m7cdwg_reserve_info.max_unstable_size = MIN_MEMORY_BLOCK_SIZE;

	m7cdwg_reserve_info.bank_size = bank_size;
	pr_info("low unstable address %lx max size %lx bank size %lx\n",
		m7cdwg_reserve_info.low_unstable_address,
		m7cdwg_reserve_info.max_unstable_size,
		m7cdwg_reserve_info.bank_size);
	return;
#endif
no_dmm:
	m7cdwg_reserve_info.low_unstable_address = high;
	m7cdwg_reserve_info.max_unstable_size = 0;
}

int __init parse_tag_memsize(const struct tag *tags);
static unsigned int mem_size_mb;

static void __init m7cdwg_reserve(void)
{
	if (mem_size_mb == 64)
		return;
...
static void __init m7cdwg_early_reserve(void)
{
	reserve_info = &m7cdwg_reserve_info;
...
static void m7cdwg_usb_dpdn_switch(int path)
{
	switch (path) {
	case PATH_USB:
...
static T_MHL_PLATFORM_DATA mhl_sii9234_device_data = {
	...
	.ci2ca = 0,
#ifdef CONFIG_FB_MSM_HDMI_MHL
	.mhl_usb_switch		= m7cdwg_usb_dpdn_switch,
...
static int64_t m7cdwg_get_usbid_adc(void)
{
...
static void m7cdwg_config_usb_id_gpios(bool output)
{
	int rc;
...
static struct cable_detect_platform_data cable_detect_pdata = {
       ...
       .usb_id_pin_gpio        = USB1_HS_ID_GPIO,
       .get_adc_cb             = m7cdwg_get_usbid_adc,
       .config_usb_id_gpios    = m7cdwg_config_usb_id_gpios,
#ifdef CONFIG_FB_MSM_HDMI_MHL
       .mhl_1v2_power = mhl_sii9234_1v2_power,
       .usb_dpdn_switch        = m7cdwg_usb_dpdn_switch,
#endif
};
...
void m7cdwg_cable_detect_register(void)
{
	int rc;
...
void m7cdwg_pm8xxx_adc_device_register(void)
{
	pr_info("%s: Register PM8XXX ADC device. rev: %d\n",
		__func__, system_rev);
	m7cdwg_cable_detect_register();
}

void m7cdwg_add_usb_devices(void)
{
...
static struct wcd9xxx_pdata m7cdwg_tabla_platform_data = {
...
static struct slim_device m7cdwg_slim_tabla = {
	.name = "tabla-slim",
	.e_addr = {0, 1, 0x10, 0, 0x17, 2},
	.dev = {
		.platform_data = &m7cdwg_tabla_platform_data,
	},
};

static struct wcd9xxx_pdata m7cdwg_tabla20_platform_data = {
	.slimbus_slave_device = {
		.name = "tabla-slave",
...
static struct slim_device m7cdwg_slim_tabla20 = {
	.name = "tabla2x-slim",
	.e_addr = {0, 1, 0x60, 0, 0x17, 2},
	.dev = {
		.platform_data = &m7cdwg_tabla20_platform_data,
	},
};
...
static void __init m7cdwg_map_io(void)
{
...
static void __init m7cdwg_init_irq(void)
{
...
static void __init m7cdwg_init_buses(void)
{
...
static mhl_driving_params m7cdwg_driving_params[] = {
...
static struct msm_hdmi_platform_data hdmi_msm_data = {
	...
	.driving_params = m7cdwg_driving_params,
	.dirving_params_count = ARRAY_SIZE(m7cdwg_driving_params),
};
...
#ifdef CONFIG_ANDROID_PMEM
#ifndef CONFIG_MSM_MULTIMEDIA_USE_ION
	&m7cdwg_android_pmem_device,
	&m7cdwg_android_pmem_adsp_device,
	&m7cdwg_android_pmem_audio_device,
#endif 
#endif 
#ifdef CONFIG_ION_MSM
	&m7cdwg_ion_dev,
...
static struct msm_spi_platform_data m7cdwg_qup_spi_gsbi5_pdata = {
...
static struct slim_boardinfo m7cdwg_slim_devices[] = {
	{
		.bus_num = 1,
		.slim_slave = &m7cdwg_slim_tabla,
	},
	{
		.bus_num = 1,
		.slim_slave = &m7cdwg_slim_tabla20,
	},
...
static struct msm_i2c_platform_data m7cdwg_i2c_qup_gsbi3_pdata = {
	.clk_freq = 384000,
	.src_clk_rate = 24000000,
...
static struct msm_i2c_platform_data m7cdwg_i2c_qup_gsbi4_pdata = {
	.clk_freq = 400000,
	.src_clk_rate = 24000000,
	.share_uart_flag = 1,
};

static struct msm_i2c_platform_data m7cdwg_i2c_qup_gsbi7_pdata = {
	.clk_freq = 400000,
	.src_clk_rate = 24000000,
	.share_uart_flag = 1,
};
...
#endif
static struct cir_platform_data m7cdwg_cir_gsbi3_pdata = {
...
static void __init m7cdwg_i2c_init(void)
{
	...
	apq8064_device_qup_i2c_gsbi3.dev.platform_data =
					&m7cdwg_i2c_qup_gsbi3_pdata;
	apq8064_device_qup_i2c_gsbi4.dev.platform_data =
					&m7cdwg_i2c_qup_gsbi4_pdata;
	apq8064_device_qup_i2c_gsbi7.dev.platform_data =
					&m7cdwg_i2c_qup_gsbi7_pdata;
}
...
static void __init m7cdwg_init_dsps(void)
{
...
static int m7cdwg_mpu3050_sensor_power_LPM(int on)
{
	int rc = 0;
...
static struct mpu3050_platform_data mpu3050_data = {
	...
	.power_LPM = m7cdwg_mpu3050_sensor_power_LPM,
};
...
static struct i2c_registry m7cdwg_i2c_devices[] __initdata = {
	{
		I2C_SURF | I2C_FFA,
...
static void __init register_i2c_devices(void)
{
	...
	for (i = 0; i < ARRAY_SIZE(m7cdwg_i2c_devices); ++i) {
		if (m7cdwg_i2c_devices[i].machs & mach_mask) {
			i2c_register_board_info(m7cdwg_i2c_devices[i].bus,
						m7cdwg_i2c_devices[i].info,
						m7cdwg_i2c_devices[i].len);
		}
	}
...
static void __init m7cdwg_receiver_init(void)
{
...
static void __init m7cdwg_cir_init(void)
{
	...
	apq8064_device_uart_gsbi3.dev.platform_data =
					&m7cdwg_cir_gsbi3_pdata;
}
#endif

extern void (*cam_vcm_on_cb)(void);
extern void (*cam_vcm_off_cb)(void);
static void __init m7cdwg_common_init(void)
{
	int rc = 0;
	...
	m7cdwg_init_pmic_register_cam_cb(&cam_vcm_on_cb, &cam_vcm_off_cb);
	...
	slim_register_board_info(m7cdwg_slim_devices,
		ARRAY_SIZE(m7cdwg_slim_devices));
	m7cdwg_init_dsps();
...
static void __init m7cdwg_allocate_memory_regions(void)
{
	m7china_allocate_fb_region();
}

static void __init m7cdwg_cdp_init(void)
{
...
static void __init m7cdwg_fixup(struct tag *tags, char **cmdline, struct meminfo *mi)
{
	...
	printk(KERN_INFO "M7CDWG_fixup:skuid=0x%x\n", skuid);
}

MACHINE_START(M7C_DWG, "UNKNOWN")
	.fixup = m7cdwg_fixup,
	.map_io = m7cdwg_map_io,
	.reserve = m7cdwg_reserve,
	.init_irq = m7cdwg_init_irq,
	.handle_irq = gic_handle_irq,
	.timer = &msm_timer,
	.init_machine = m7cdwg_cdp_init,
	.init_early = m7cdwg_allocate_memory_regions,
	.init_very_early = m7cdwg_early_reserve,
	.restart = msm_restart,
MACHINE_END
