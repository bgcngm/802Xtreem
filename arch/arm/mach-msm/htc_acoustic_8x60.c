...
#define ACOUSTIC_UPDATE_LISTEN_NOTIFICATION  _IOW(ACOUSTIC_IOCTL_MAGIC, 48, unsigned) // acoustic warning message
...
static struct switch_dev sdev_listen_notification; // acoustic warning message
