...
//#define MSM_RAM_CONSOLE_PHYS    0x8F900000
...
#define MSM_TZLOG_PHYS          MSM_HTC_DEBUG_INFO_PHYS /*0x8F9E0000*/
#define MSM_TZLOG_SIZE          (SZ_64K)

#undef MSM_TZ_DOG_BARK_REG_SAVE_PHYS
#undef MSM_TZ_DOG_BARK_REG_SAVE_SIZE

#define MSM_TZ_DOG_BARK_REG_SAVE_PHYS   (MSM_HTC_DEBUG_INFO_PHYS + MSM_TZLOG_SIZE) /*0x8F9F0000*/
#define MSM_TZ_DOG_BARK_REG_SAVE_SIZE   (SZ_4K)

#undef MSM_KERNEL_FOOTPRINT_PHYS
#undef MSM_KERNEL_FOOTPRINT_SIZE

#define MSM_KERNEL_FOOTPRINT_PHYS   (MSM_TZ_DOG_BARK_REG_SAVE_PHYS + MSM_TZ_DOG_BARK_REG_SAVE_SIZE) /*0x8F9F1000*/
#define MSM_KERNEL_FOOTPRINT_SIZE   (SZ_4K)

#undef MSM_KALLSYMS_SAVE_PHYS
#undef MSM_KALLSYMS_SAVE_SIZE

#define MSM_KALLSYMS_SAVE_PHYS      (MSM_KERNEL_FOOTPRINT_PHYS + MSM_KERNEL_FOOTPRINT_SIZE) /* 0x8F9F2000 */
#define MSM_KALLSYMS_SAVE_SIZE      (MSM_HTC_DEBUG_INFO_SIZE - MSM_TZLOG_SIZE - MSM_TZ_DOG_BARK_REG_SAVE_SIZE- MSM_KERNEL_FOOTPRINT_SIZE)   /*56K*/
#endif
