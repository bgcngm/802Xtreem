...
#define MSM_KALLSYMS_SAVE_BASE			IOMEM(0xFB601000)	/* 56K */
...
#define DDR_FOOT_PRINT_BASE		(MSM_KERNEL_FOOTPRINT_BASE + 0x300)	/* Size: 0x4 */

#ifdef CONFIG_TRACING_SPINLOCK
#define MSM_SPIN_LOCK_IRQSAVE_INFO_BASE (MSM_KERNEL_FOOTPRINT_BASE + 0x400)	/* Size: 0x10 */
#endif

#ifdef CONFIG_TRACING_WORKQUEUE_HISTORY
#define MSM_WQ_INFO_BASE 		(MSM_KERNEL_FOOTPRINT_BASE + 0x430)	/*Size: 0x780 */
#endif
