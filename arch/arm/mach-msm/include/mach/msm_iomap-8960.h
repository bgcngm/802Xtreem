...
/* MSM_HTC_DEBUG_INFO_PHYS --- END */
	...
	#define MSM_HTC_RAM_CONSOLE_SIZE	(SZ_1M - SZ_128K - SZ_64K) /* 128K for debug info + 64K for EDIAG*/
...
/* MSM_HTC_DEBUG_INFO_PHYS --- BEGIN */
#define MSM_TZLOG_PHYS			MSM_HTC_DEBUG_INFO_PHYS /*0x8F1E0000*/
#define MSM_TZLOG_SIZE			SZ_64K

#define MSM_TZ_DOG_BARK_REG_SAVE_PHYS	(MSM_HTC_DEBUG_INFO_PHYS + MSM_TZLOG_SIZE) /*0x8F1F0000*/
#define MSM_TZ_DOG_BARK_REG_SAVE_SIZE	SZ_4K

#define MSM_KERNEL_FOOTPRINT_PHYS	(MSM_TZ_DOG_BARK_REG_SAVE_PHYS + MSM_TZ_DOG_BARK_REG_SAVE_SIZE) /*0x8F1F1000*/
#define MSM_KERNEL_FOOTPRINT_SIZE		SZ_4K

#define MSM_KALLSYMS_SAVE_PHYS	(MSM_KERNEL_FOOTPRINT_PHYS + MSM_KERNEL_FOOTPRINT_SIZE) /* 0x8F1F2000 */
#define MSM_KALLSYMS_SAVE_SIZE	(SZ_64K - MSM_TZ_DOG_BARK_REG_SAVE_SIZE - MSM_KERNEL_FOOTPRINT_SIZE) /*56K*/
