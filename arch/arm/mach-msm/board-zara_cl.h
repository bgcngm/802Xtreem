...
#define	GPIO(X)		(X)
#ifndef __ARCH_ARM_MACH_MSM_BOARD_ZARA_CL_H__
#define __ARCH_ARM_MACH_MSM_BOARD_ZARA_CL_H__
...
#endif /*__ARCH_ARM_MACH_MSM_BOARD_ZARA_CL_H__*/

extern int panel_type;
extern struct msm_camera_board_info zara_cl_camera_board_info_XA;
extern struct msm_camera_board_info zara_cl_camera_board_info_XB;
extern struct platform_device zara_cl_msm_rawchip_device;

int __init zara_cl_gpiomux_init(void);
int __init zara_cl_init_keypad(void);
void zara_cl_allocate_fb_region(void);
void zara_cl_mdp_writeback(struct memtype_reserve* reserve_table);
int __init zara_cl_init_mmc(void);
int __init zara_cl_wifi_init(void);
void __init zara_cl_init_cam(void);
void zara_cl_init_fb(void);
