...
void __init m7cdug_pm8xxx_gpio_mpp_init(void)
{
	int i, rc;
...
static struct pm8xxx_pwrkey_platform_data m7cdug_pm8921_pwrkey_pdata = {
	.pull_up		= 1,
	.kpd_trigger_delay_us	= 15625,
	.wakeup			= 1,
};

static struct pm8xxx_misc_platform_data m7cdug_pm8921_misc_pdata = {
	.priority		= 0,
};
...
static struct pm8xxx_led_platform_data m7cdug_pm8921_leds_pdata = {
	.num_leds = ARRAY_SIZE(pm8921_led_info),
	.leds = pm8921_led_info,
};


static struct pm8xxx_adc_amux m7cdug_pm8921_adc_channels_data[] = {
...
static struct pm8xxx_adc_properties m7cdug_pm8921_adc_data = {
	.adc_vdd_reference	= 1800, 
	.bitresolution		= 15,
	.bipolar                = 0,
};
static const struct pm8xxx_adc_map_pt m7cdug_adcmap_btm_table[] = {
	{-200,	1670},
	{-190,	1662},
	{-180,	1654},
	{-170,	1645},
...
static struct pm8xxx_adc_map_table pm8xxx_adcmap_btm_table = {
	.table = m7cdug_adcmap_btm_table,
	.size = ARRAY_SIZE(m7cdug_adcmap_btm_table),
};

static struct pm8xxx_adc_platform_data m7cdug_pm8921_adc_pdata = {
	.adc_channel		= m7cdug_pm8921_adc_channels_data,
	.adc_num_board_channel	= ARRAY_SIZE(m7cdug_pm8921_adc_channels_data),
	.adc_prop		= &m7cdug_pm8921_adc_data,
	.adc_mpp_base		= PM8921_MPP_PM_TO_SYS(1),
	.adc_map_btm_table	= &pm8xxx_adcmap_btm_table,
	.pm8xxx_adc_device_register	= m7cdug_pm8xxx_adc_device_register,
};

static struct pm8xxx_mpp_platform_data
m7cdug_pm8921_mpp_pdata __devinitdata = {
	.mpp_base	= PM8921_MPP_PM_TO_SYS(1),
};

static struct pm8xxx_gpio_platform_data
m7cdug_pm8921_gpio_pdata __devinitdata = {
	.gpio_base	= PM8921_GPIO_PM_TO_SYS(1),
};

static struct pm8xxx_irq_platform_data
m7cdug_pm8921_irq_pdata __devinitdata = {
...
static int m7cdug_pm8921_therm_mitigation[] = {
	1100,
	700,
	600,
	225,
...
pm8921_chg_pdata __devinitdata = {
	...
	.thermal_mitigation	= m7cdug_pm8921_therm_mitigation,
	.thermal_levels		= ARRAY_SIZE(m7cdug_pm8921_therm_mitigation),
...
m7cdug_pm8921_platform_data __devinitdata = {
	.regulator_pdatas	= m7china_pm8921_regulator_pdata,
	.irq_pdata		= &m7cdug_pm8921_irq_pdata,
	.gpio_pdata		= &m7cdug_pm8921_gpio_pdata,
	.mpp_pdata		= &m7cdug_pm8921_mpp_pdata,
	.rtc_pdata		= &m7cdug_pm8921_rtc_pdata,
	.pwrkey_pdata	= &m7cdug_pm8921_pwrkey_pdata,
	.misc_pdata		= &m7cdug_pm8921_misc_pdata,
	.leds_pdata		= &m7cdug_pm8921_leds_pdata,
	.adc_pdata		= &m7cdug_pm8921_adc_pdata,
	.charger_pdata		= &pm8921_chg_pdata,
	.bms_pdata		= &pm8921_bms_pdata,
	.ccadc_pdata		= &m7cdug_pm8xxx_ccadc_pdata,
	.vibrator_pdata         = &pm8xxx_vib_pdata,
};

static struct pm8xxx_irq_platform_data
m7cdug_pm8821_irq_pdata __devinitdata = {
...
static struct pm8xxx_mpp_platform_data
m7cdug_pm8821_mpp_pdata __devinitdata = {
	.mpp_base	= PM8821_MPP_PM_TO_SYS(1),
};

static struct pm8821_platform_data
m7cdug_pm8821_platform_data __devinitdata = {
	.irq_pdata	= &m7cdug_pm8821_irq_pdata,
	.mpp_pdata	= &m7cdug_pm8821_mpp_pdata,
};

static struct msm_ssbi_platform_data m7cdug_ssbi_pm8921_pdata __devinitdata = {
	.controller_type = MSM_SBI_CTRL_PMIC_ARBITER,
	.slave	= {
		.name		= "pm8921-core",
		.platform_data	= &m7cdug_pm8921_platform_data,
	},
};

static struct msm_ssbi_platform_data m7cdug_ssbi_pm8821_pdata __devinitdata = {
	.controller_type = MSM_SBI_CTRL_PMIC_ARBITER,
	.slave	= {
		.name		= "pm8821-core",
		.platform_data	= &m7cdug_pm8821_platform_data,
	},
};

void __init m7cdug_init_pmic(void)
{
	if (system_rev == EVM) {
	...
	apq8064_device_ssbi_pmic1.dev.platform_data =
						&m7cdug_ssbi_pm8921_pdata;
	apq8064_device_ssbi_pmic2.dev.platform_data =
				&m7cdug_ssbi_pm8821_pdata;
	m7cdug_pm8921_platform_data.num_regulators =
					m7china_pm8921_regulator_pdata_len;

}

void __init m7cdug_init_pmic_register_cam_cb(void *cam_vcm_on_cb, void *cam_vcm_off_cb)
{
	if (cam_vcm_on_cb)
