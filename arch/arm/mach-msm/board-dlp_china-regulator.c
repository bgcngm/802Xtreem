...
VREG_CONSUMERS(L23) = {
	...
	REGULATOR_SUPPLY("tfa9887_vdd_L23",	NULL), /* use for XA */
...
VREG_CONSUMERS(LVS2) = {
	...
	REGULATOR_SUPPLY("tfa9887_vdd_LVS2",NULL), /* used for >= XB */
};
VREG_CONSUMERS(LVS3) = {
...
struct regulator_init_data dlp_china_saw_regulator_pdata_8921_s5 =
	/*	      ID  vreg_name	       min_uV   max_uV */
	SAW_VREG_INIT(S5, "8921_s5",	       850000, 1300000);
struct regulator_init_data dlp_china_saw_regulator_pdata_8921_s6 =
	SAW_VREG_INIT(S6, "8921_s6",	       850000, 1300000);

struct regulator_init_data dlp_china_saw_regulator_pdata_8821_s0 =
	/*	      ID       vreg_name	min_uV  max_uV */
	SAW_VREG_INIT(8821_S0, "8821_s0",       850000, 1300000);
struct regulator_init_data dlp_china_saw_regulator_pdata_8821_s1 =
...
dlp_china_rpm_regulator_init_data[] __devinitdata = {
	...
	RPM_LDO(L22, 1, 1, 0, 3000000, 3000000, NULL,          0,     0),
...
int dlp_china_pm8921_regulator_pdata_len __devinitdata =
	ARRAY_SIZE(dlp_china_pm8921_regulator_pdata);

struct rpm_regulator_platform_data dlp_china_rpm_regulator_pdata __devinitdata = {
	.init_data		= dlp_china_rpm_regulator_init_data,
	.num_regulators		= ARRAY_SIZE(dlp_china_rpm_regulator_init_data),
