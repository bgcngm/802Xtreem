...
int __init dlxp_wl_init_keypad(void);
...
#define CPU_BOOT_CONFIG6	GPIO(4)
...
#define WIRELESS_CHARGER_DISABLE	GPIO(50)
...
#define RAW_INTR1		GPIO(58)
#define AP2MDM_PON_RESET_N	GPIO(59)
#define AP2MDM_WAKEUP		GPIO(60)
#define RAW_INTR0		GPIO(61)
...
extern struct pm8xxx_regulator_platform_data
	dlxp_wl_pm8921_regulator_pdata[] __devinitdata;

extern int dlxp_wl_pm8921_regulator_pdata_len __devinitdata;
...
extern struct gpio_regulator_platform_data
	dlxp_wl_gpio_regulator_pdata[] __devinitdata;

extern struct rpm_regulator_platform_data
	dlxp_wl_rpm_regulator_pdata __devinitdata;

extern struct regulator_init_data dlxp_wl_saw_regulator_pdata_8921_s5;
extern struct regulator_init_data dlxp_wl_saw_regulator_pdata_8921_s6;
extern struct regulator_init_data dlxp_wl_saw_regulator_pdata_8821_s0;
extern struct regulator_init_data dlxp_wl_saw_regulator_pdata_8821_s1;

struct mmc_platform_data;
int __init apq8064_add_sdcc(unsigned int controller,
		struct mmc_platform_data *plat);

void dlxp_wl_init_mmc(void);
int dlxp_wl_wifi_init(void);
void dlxp_wl_init_gpiomux(void);
void dlxp_wl_init_pmic(void);

#if 1	// for pre-evt no camera
extern struct platform_device dlxp_wl_msm_rawchip_device;
#endif
void dlxp_wl_init_cam(void);

#define APQ_8064_GSBI1_QUP_I2C_BUS_ID 0
#define APQ_8064_GSBI3_QUP_I2C_BUS_ID 3
#define APQ_8064_GSBI4_QUP_I2C_BUS_ID 4

void dlxp_wl_init_fb(void);
void dlxp_wl_allocate_fb_region(void);
void dlxp_wl_mdp_writeback(struct memtype_reserve *reserve_table);

void dlxp_wl_init_gpu(void);
void dlxp_wl_pm8xxx_gpio_mpp_init(void);
void dlxp_wl_usb_uart_switch(int nvbus);
