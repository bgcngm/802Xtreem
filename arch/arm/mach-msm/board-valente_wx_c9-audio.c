...
static const struct snd_soc_dapm_widget valente_wx_c9_dapm_widgets[] = {
...
static int msm8960_audrx_init(struct snd_soc_pcm_runtime *rtd)
{
	...
	snd_soc_dapm_new_controls(dapm, valente_wx_c9_dapm_widgets,
				ARRAY_SIZE(valente_wx_c9_dapm_widgets));
...
MODULE_DESCRIPTION("ALSA Platform Valente_wx_c9");
