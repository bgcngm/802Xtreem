...
int __init dlp_dug_init_keypad(void);
...
#define MHL_RSTz		GPIO(55)
#define NFC_IRQ		GPIO(56)
#define AUD_HP_EN		GPIO(57)
...
#define AUD_RECEIVER_SEL	PMGPIO(44)

/* FIX ME: Redundant setting */
/* Just for the build pass of some improper Camera common code */
...
extern struct pm8xxx_regulator_platform_data
	dlp_china_pm8921_regulator_pdata[] __devinitdata;

extern int dlp_china_pm8921_regulator_pdata_len __devinitdata;
...
extern struct gpio_regulator_platform_data
	dlp_china_gpio_regulator_pdata[] __devinitdata;

extern struct rpm_regulator_platform_data
	dlp_china_rpm_regulator_pdata __devinitdata;

extern struct regulator_init_data dlp_china_saw_regulator_pdata_8921_s5;
extern struct regulator_init_data dlp_china_saw_regulator_pdata_8921_s6;
extern struct regulator_init_data dlp_china_saw_regulator_pdata_8821_s0;
extern struct regulator_init_data dlp_china_saw_regulator_pdata_8821_s1;

struct mmc_platform_data;
int __init apq8064_add_sdcc(unsigned int controller,
		struct mmc_platform_data *plat);

void dlp_china_init_mmc(void);
int m7china_wifi_init(void);
void dlp_china_init_gpiomux(void);
void dlp_dug_init_pmic(void);

#if 1	// for pre-evt no camera
extern struct platform_device dlp_china_msm_rawchip_device;
#endif
void dlp_china_init_cam(void);
...
void dlp_china_init_fb(void);
void dlp_china_allocate_fb_region(void);
void dlp_china_mdp_writeback(struct memtype_reserve *reserve_table);

void dlp_china_init_gpu(void);
void dlp_dug_pm8xxx_gpio_mpp_init(void);
void m7china_usb_uart_switch(int nvbus);
extern void set_acpu_speedbin_filter_freq(int bin,  unsigned long freq);
