...
static struct mmc_platform_data *dlp_china_sdc1_pdata = &sdc1_data;
#else
static struct mmc_platform_data *dlp_china_sdc1_pdata;
#endif
...
static unsigned int dlp_china_sdc3_slot_type = MMC_TYPE_SD;
static struct mmc_platform_data sdc3_data = {
	.ocr_mask       = MMC_VDD_27_28 | MMC_VDD_28_29,
	.mmc_bus_width  = MMC_CAP_4_BIT_DATA,
	.sup_clk_table	= sdc3_sup_clk_rates,
	.sup_clk_cnt	= ARRAY_SIZE(sdc3_sup_clk_rates),
	.slot_type      = &dlp_china_sdc3_slot_type,
...
static struct mmc_platform_data *dlp_china_sdc3_pdata = &sdc3_data;
#else
static struct mmc_platform_data *dlp_china_sdc3_pdata;
#endif
#endif
...
void __init dlp_china_init_mmc(void)
{
	//wifi_status_cb = NULL;

	printk(KERN_INFO "dlp_china: %s\n", __func__);
...
/* fix it: gpio 35 is for CIR_RST*/
	...
	if (machine_is_m7_evm()) {
		dlp_china_sdc3_pdata->status_gpio = 0;
		dlp_china_sdc3_pdata->status_irq = 0;
	}
	apq8064_add_sdcc(1, dlp_china_sdc1_pdata);
	apq8064_add_sdcc(3, dlp_china_sdc3_pdata);
