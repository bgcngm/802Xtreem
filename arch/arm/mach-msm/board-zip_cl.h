...
#define	GPIO(X)		(X)
#ifndef __ARCH_ARM_MACH_MSM_BOARD_ZIP_CL_H__
#define __ARCH_ARM_MACH_MSM_BOARD_ZIP_CL_H__
...
#define MSM_SDMC_CDz				GPIO(10)
#define MSM_AUD_HP_EN				GPIO(11)
#define MSM_RAW_1V15_EN				GPIO(12)
#define MSM_MSM_NC_GPIO_13			GPIO(13)
...
#define MSM_AUD_SPK_I2S_DI			GPIO(49)
#define MSM_RAW_INTR1				GPIO(50)
#define MSM_RAW_RSTN				GPIO(51)
#define MSM_AUD_SPK_I2S_DO			GPIO(52)
...
#define MSM_MSM_NC_GPIO_93			GPIO(93)
#define MSM_MBAT_INz				GPIO(94)
#define MSM_MSM_NC_GPIO_95			GPIO(95)
#define MSM_MSM_NC_GPIO_96			GPIO(96)
...
#define MSM_WDOG_DISABLE			GPIO(111)
#define MSM_BOOT_CONFIG_6			GPIO(112)
#define MSM_MSM_NC_GPIO_113			GPIO(113)
#define MSM_MSM_NC_GPIO_114			GPIO(114)
#define MSM_MSM_NC_GPIO_115			GPIO(115)
#define MSM_MSM_NC_GPIO_116			GPIO(116)
#define MSM_W_ANT_SW_SEL2			GPIO(117)
#define MSM_W_ANT_SW_SEL1			GPIO(118)
#define MSM_W_ANT_SW_SEL0			GPIO(119)
#define MSM_W_PA1_R0				GPIO(120)
#define MSM_W_PA1_R1				GPIO(121)
#define MSM_W_PA0_R0				GPIO(122)
#define MSM_W_PA0_R1				GPIO(123)
#define MSM_W_WTR1_RF_ON			GPIO(124)
#define MSM_W_WTR0_RF_ON			GPIO(125)
#define MSM_W_WTR0_RX_ON			GPIO(126)
#define MSM_TX_AGC_ADJ				GPIO(127)
#define MSM_W_PA_ON8_BC1			GPIO(128)
#define MSM_W_PA_ON7_B4				GPIO(129)
#define MSM_W_PA_ON6_B25			GPIO(130)
#define MSM_MSM_NC_GPIO_131			GPIO(131)
#define MSM_W_PA_ON4_B13			GPIO(132)
#define MSM_MSM_NC_GPIO_133			GPIO(133)
#define MSM_MSM_NC_GPIO_134			GPIO(134)
#define MSM_W_PA_ON1_BC0_10			GPIO(135)
#define MSM_MSM_NC_GPIO_136			GPIO(136)
#define MSM_W_GPS_LNA_EN			GPIO(137)
#define MSM_V_3G_PA0_EN				GPIO(138)
#define MSM_MSM_NC_GPIO_139			GPIO(139)
#define MSM_W_WTR1_SSBI_PRX_DRX			GPIO(140)
#define MSM_W_WTR1_SSBI_TX_GNSS			GPIO(141)
#define MSM_W_WTR0_SSBI_PRX_DRX			GPIO(142)
#define MSM_W_WTR0_SSBI_TX_GNSS			GPIO(143)
#define MSM_MSM_NC_GPIO_144			GPIO(144)
#define MSM_V_3G_PA1_EN				GPIO(145)
#define MSM_MSM_NC_GPIO_146			GPIO(146)
#define MSM_MSM_NC_GPIO_147			GPIO(147)
#define MSM_MSM_NC_GPIO_148			GPIO(148)
#define MSM_MSM_NC_GPIO_149			GPIO(149)
#define MSM_SW_ANT_0				GPIO(150)
#define MSM_SW_ANT_1				GPIO(151)
#endif /*__ARCH_ARM_MACH_MSM_BOARD_ZIP_CL_H__*/

extern int panel_type;
extern struct msm_camera_board_info zip_cl_camera_board_info;
extern struct platform_device zip_cl_msm_rawchip_device;
extern struct platform_device msm8930_msm_rawchip_device;

int __init zip_cl_gpiomux_init(void);
int __init zip_cl_init_keypad(void);
void zip_cl_allocate_fb_region(void);
void zip_cl_mdp_writeback(struct memtype_reserve* reserve_table);
int __init zip_cl_init_mmc(void);
int __init zip_cl_wifi_init(void);
void __init zip_cl_init_cam(void);
void zip_cl_init_fb(void);
