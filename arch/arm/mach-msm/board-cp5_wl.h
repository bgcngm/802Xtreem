...
#define	GPIO(X)		(X)
#ifndef __ARCH_ARM_MACH_MSM_BOARD_CP5_WL_H__
#define __ARCH_ARM_MACH_MSM_BOARD_CP5_WL_H__
...
#define PM_BCM4334_SLEEP_CLK		PMGPIO(8)
#define PM_BATT_ALARM				PMGPIO(9)
#define PM_NC_GPIO_10				PMGPIO(10)
#define PM_NC_GPIO_11				PMGPIO(11)
#define PM_NC_GPIO_12				PMGPIO(12)

#endif /*__ARCH_ARM_MACH_MSM_BOARD_CP5_WL_H__*/

extern int panel_type;
extern struct msm_camera_board_info cp5_wl_camera_board_info_XA;
extern struct msm_camera_board_info cp5_wl_camera_board_info_XB;
extern struct platform_device cp5_wl_msm_rawchip_device;

int __init cp5_wl_gpiomux_init(void);
int __init cp5_wl_init_keypad(void);
void cp5_wl_allocate_fb_region(void);
void cp5_wl_mdp_writeback(struct memtype_reserve* reserve_table);
int __init cp5_wl_init_mmc(void);
int __init cp5_wl_wifi_init(void);
void __init cp5_wl_init_cam(void);
void cp5_wl_init_fb(void);
