...
static uint32_t wifi_on_gpio_table[] = {
	...
	GPIO_CFG(MSM_WW_IRQ, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), /* WLAN IRQ */
};
...
static uint32_t wifi_off_gpio_table[] = {
	...
	GPIO_CFG(MSM_WW_IRQ, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* WLAN IRQ */
};
...
static int operaul_wifi_cd;	/* WiFi virtual 'card detect' status */
...
int operaul_wifi_power(int on)
{
	...
	gpio_set_value(MSM_WIFI_SHUTDOWNz, on); /* WIFI_SHUTDOWN */
