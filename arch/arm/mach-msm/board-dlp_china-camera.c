...
void dlp_china_vcm_vreg_on(void);
void dlp_china_vcm_vreg_off(void);
#endif
/* HTC_END */
...
static struct gpiomux_setting cam_settings[] = {
	...
	{
		.func = GPIOMUX_FUNC_1, /* 20 - A FUNC1 4MA*/
		.drv = GPIOMUX_DRV_4MA,
		.pull = GPIOMUX_PULL_NONE,
	},
};

static struct msm_gpiomux_config dlp_china_cam_common_configs[] = {
	{
		.gpio = CAM_PIN_GPIO_CAM_MCLK0,
		.settings = {
			[GPIOMUX_ACTIVE]    = &cam_settings[20], /*A FUNC1 4MA*/
			[GPIOMUX_SUSPENDED] = &cam_settings[12], /*O(L) 4MA*/
		},
	},
	{
...
static int dlp_china_csi_vreg_on(void);
static int dlp_china_csi_vreg_off(void);

struct msm_camera_device_platform_data dlp_china_msm_camera_csi_device_data[] = {
	{
		.ioclk.mclk_clk_rate = 24000000,
		.ioclk.vfe_clk_rate  = 228570000,
		.csid_core = 0,
		.camera_csi_on = dlp_china_csi_vreg_on,
		.camera_csi_off = dlp_china_csi_vreg_off,
...
int dlp_china_flashlight_control(int mode)
{
...
static struct msm_camera_sensor_flash_src msm_camera_flash_src = {
	...
	.camera_flash = dlp_china_flashlight_control,
};
#endif
#endif
...
static int dlp_china_use_ext_1v2(void)
{
	return 1;
}

static int dlp_china_rawchip_vreg_on(void)
{
	int rc;
...
static int dlp_china_rawchip_vreg_off(void)
{
	int rc = 0;
	int gpio_cam_d1v2_en=0;
	int gpio_cam_d1v8_en=0;
...
static struct msm_camera_rawchip_info dlp_china_msm_rawchip_board_info = {
	...
	.camera_rawchip_power_on = dlp_china_rawchip_vreg_on,
	.camera_rawchip_power_off = dlp_china_rawchip_vreg_off,
	.rawchip_use_ext_1v2 = dlp_china_use_ext_1v2,
};

struct platform_device dlp_china_msm_rawchip_device = {
	.name	= "yushanII",
	.dev	= {
		.platform_data = &dlp_china_msm_rawchip_board_info,
	},
};
#endif
...
static void dlp_china_yushanii_probed(enum htc_camera_image_type_board htc_image)
{
...
/* HTC_START - for HW VCM work-around */
#if defined(CONFIG_RUMBAS_ACT)
	.vcm_wa_vreg_on = dlp_china_vcm_vreg_on,
	.vcm_wa_vreg_off = dlp_china_vcm_vreg_off,
#endif
/* HTC_END */
};
#endif
...
#ifdef CONFIG_IMX175
static int dlp_china_imx175_vreg_on(void)
{
	int rc;
...
static int dlp_china_imx175_vreg_off(void)
{
	int rc = 0;
	unsigned gpio_cam_d1v2_en = 0;
...
static struct msm_camera_sensor_info msm_camera_sensor_imx175_data = {
	.sensor_name	= "imx175",
	.camera_power_on = dlp_china_imx175_vreg_on,
	.camera_power_off = dlp_china_imx175_vreg_off,
	.pdata	= &dlp_china_msm_camera_csi_device_data[0],
...
#ifdef CONFIG_IMX135
static int dlp_china_imx135_vreg_on(void)
{
	int rc;
	int gpio_cam_d1v2_en=0;
	pr_info("%s\n", __func__);
...
static int dlp_china_imx135_vreg_off(void)
{
	int rc = 0;
	int gpio_cam_d1v2_en=0;
	pr_info("%s\n", __func__);
...
static struct msm_camera_sensor_info msm_camera_sensor_imx135_data = {
	.sensor_name	= "imx135",
	.camera_power_on = dlp_china_imx135_vreg_on,
	.camera_power_off = dlp_china_imx135_vreg_off,
	.camera_yushanii_probed = dlp_china_yushanii_probed,
	.pdata	= &dlp_china_msm_camera_csi_device_data[0],
...
#ifdef CONFIG_VD6869
static int dlp_china_vd6869_vreg_on(void)
{
	int rc;
	int gpio_cam_d1v2_en=0;
	pr_info("%s\n", __func__);
	...
	rc = gpio_request(gpio_cam_d1v2_en, "MCAM_D1V2_EN");
	pr_info("%s: gpio_cam_d1v2_en (%d)\n", __func__, rc);
	if (rc) {
		pr_err("sensor_power_enable\
			(\"gpio %d\", 1.2V) FAILED %d\n",
...
static int dlp_china_vd6869_vreg_off(void)
{
	int rc = 0;
	int gpio_cam_d1v2_en=0;
	pr_info("%s\n", __func__);
...
static struct msm_camera_sensor_info msm_camera_sensor_vd6869_data = {
	.sensor_name	= "vd6869",
	.camera_power_on = dlp_china_vd6869_vreg_on,
	.camera_power_off = dlp_china_vd6869_vreg_off,
	.camera_yushanii_probed = dlp_china_yushanii_probed,
	.pdata	= &dlp_china_msm_camera_csi_device_data[0],
...
static int dlp_china_ov4688_vreg_on(void)
{
	int rc =0;
	pr_info("%s\n", __func__);
...
static int dlp_china_ov4688_vreg_off(void)
{
	int rc = 0;
	pr_info("%s\n", __func__);
...
static struct msm_camera_sensor_info msm_camera_sensor_ov4688_data = {
	.sensor_name	= "ov4688",
	.camera_power_on = dlp_china_ov4688_vreg_on,
	.camera_power_off = dlp_china_ov4688_vreg_off,
	.camera_yushanii_probed = dlp_china_yushanii_probed,
	.pdata	= &dlp_china_msm_camera_csi_device_data[0],
...
#endif//end ov4688
#ifdef CONFIG_IMX091
static int dlp_china_imx091_vreg_on(void)
{
	int rc;
	pr_info("%s\n", __func__);
...
static int dlp_china_imx091_vreg_off(void)
{
	int rc = 0;
...
static struct msm_camera_sensor_info msm_camera_sensor_imx091_data = {
	.sensor_name	= "imx091",
	.camera_power_on = dlp_china_imx091_vreg_on,
	.camera_power_off = dlp_china_imx091_vreg_off,
	.pdata	= &dlp_china_msm_camera_csi_device_data[0],
...
static int dlp_china_s5k3h2yx_vreg_on(void)
{
	int rc;
	pr_info("%s\n", __func__);
...
static int dlp_china_s5k3h2yx_vreg_off(void)
{
	int rc = 0;
...
static struct msm_camera_sensor_info msm_camera_sensor_s5k3h2yx_data = {
	...
	.camera_power_on = dlp_china_s5k3h2yx_vreg_on,
	.camera_power_off = dlp_china_s5k3h2yx_vreg_off,
	.pdata	= &dlp_china_msm_camera_csi_device_data[0],
...
static int dlp_china_s5k6a1gx_vreg_on(void)
{
	int rc;
	pr_info("%s\n", __func__);
...
static int dlp_china_s5k6a1gx_vreg_off(void)
{
	int rc;
	pr_info("%s\n", __func__);
...
static struct msm_camera_sensor_info msm_camera_sensor_s5k6a1gx_data = {
	...
	.vcm_pwd	= 0,
	.vcm_enable	= 0,
	.camera_power_on = dlp_china_s5k6a1gx_vreg_on,
	.camera_power_off = dlp_china_s5k6a1gx_vreg_off,
	.pdata	= &dlp_china_msm_camera_csi_device_data[1],
...
#ifdef CONFIG_AR0260
static int dlp_china_ar0260_vreg_on(void)
{
	int rc;
...
static int dlp_china_ar0260_vreg_off(void)
{
	int rc = 0;
	pr_info("%s\n", __func__);
...
static struct msm_camera_sensor_info msm_camera_sensor_ar0260_data = {
	...
	.vcm_pwd	= 0,
	.vcm_enable	= 0,
	.camera_power_on = dlp_china_ar0260_vreg_on,
	.camera_power_off = dlp_china_ar0260_vreg_off,
#ifdef CONFIG_CAMERA_IMAGE_NONE_BOARD
	.pdata	= &dlp_china_msm_camera_csi_device_data[1],
#else
	.pdata	= &dlp_china_msm_camera_csi_device_data[0],
...
#ifdef CONFIG_OV2722
static int dlp_china_ov2722_vreg_on(void)
{
	int rc;
	pr_info("%s\n", __func__);
...
static int dlp_china_ov2722_vreg_off(void)
{
	int rc = 0;
	pr_info("%s\n", __func__);
...
static struct msm_camera_sensor_info msm_camera_sensor_ov2722_data = {
	...
	.vcm_pwd	= 0,
	.vcm_enable	= 0,
	.camera_power_on = dlp_china_ov2722_vreg_on,
	.camera_power_off = dlp_china_ov2722_vreg_off,
	.camera_yushanii_probed = dlp_china_yushanii_probed,
#ifdef CONFIG_CAMERA_IMAGE_NONE_BOARD
	.pdata	= &dlp_china_msm_camera_csi_device_data[1],
#else
...
#ifdef CONFIG_I2C
static struct i2c_board_info dlp_china_camera_i2c_boardinfo_imx135_ar0260[] = {
#ifdef CONFIG_IMX135
		{
...
static struct i2c_board_info dlp_china_camera_i2c_boardinfo_imx135_ov2722[] = {
#ifdef CONFIG_IMX135
		{
		I2C_BOARD_INFO("imx135", 0x20 >> 1),
		.platform_data = &msm_camera_sensor_imx135_data,
...
static struct i2c_board_info dlp_china_camera_i2c_boardinfo_vd6869_ar0260[] = {
#ifdef CONFIG_VD6869
		{
...
static struct i2c_board_info dlp_china_camera_i2c_boardinfo_vd6869_ov2722[] = {
#ifdef CONFIG_VD6869
		{
		I2C_BOARD_INFO("vd6869", 0x20 >> 1),
		.platform_data = &msm_camera_sensor_vd6869_data,
...
struct i2c_board_info dlxp_china_camera_i2c_boardinfo_ov4688_0x6c_ov2722[] = {
...
struct i2c_board_info dlxp_china_camera_i2c_boardinfo_ov4688_0x20_ov2722[] = {
...
int dlp_china_main_camera_id(void)
{
	int rc = 0;
...
int dlp_china_front_camera_id(void)
{
	int rc = 0;
...
void dlp_china_vcm_vreg_on(void)
{
	...
	rc = dlp_china_rawchip_vreg_on();
	if (rc < 0) {
		pr_err("%s dlp_china_rawchip_vreg_on failed\n", __func__);
		return;
	}
...
void dlp_china_vcm_vreg_off(void)
{
	...
	dlp_china_rawchip_vreg_off();
}
#endif
/* HTC_END */

void __init dlp_china_init_cam(void)
{
	int main_camera_id = CAMERA_SENSOR_ID_ST_4M;
	int front_camera_id = CAMERA_SENSOR_ID_OV2722_2M;

	pr_info("%s", __func__);
	msm_gpiomux_install(dlp_china_cam_common_configs,
			ARRAY_SIZE(dlp_china_cam_common_configs));
	...
	main_camera_id = dlp_china_main_camera_id();
	front_camera_id = dlp_china_front_camera_id();
	pr_info("main_camera id = %d , front_camera_id=%d\n", main_camera_id, front_camera_id);

	pr_info("[CAM] engineerid=%d\n",engineerid);
	pr_info("[CAM] system_rev=%d\n",system_rev);
#ifdef CONFIG_I2C
	if (system_rev == 0) {
		...
		if (main_camera_id == CAMERA_SENSOR_ID_ST_4M) {
			i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
				dlp_china_camera_i2c_boardinfo_vd6869_ov2722,
				ARRAY_SIZE(dlp_china_camera_i2c_boardinfo_vd6869_ov2722));

			update_yushanII_flag(HTC_CAMERA_IMAGE_YUSHANII_BOARD);
		} else {
			i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
				dlp_china_camera_i2c_boardinfo_imx135_ar0260,
				ARRAY_SIZE(dlp_china_camera_i2c_boardinfo_imx135_ar0260));
		...
		if (main_camera_id == CAMERA_SENSOR_ID_ST_4M) {
			if (front_camera_id == CAMERA_SENSOR_ID_AR0260_2M) {
				i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
					dlp_china_camera_i2c_boardinfo_vd6869_ar0260,
					ARRAY_SIZE(dlp_china_camera_i2c_boardinfo_vd6869_ar0260));
			} else {
				i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
					dlp_china_camera_i2c_boardinfo_vd6869_ov2722,
					ARRAY_SIZE(dlp_china_camera_i2c_boardinfo_vd6869_ov2722));
			...
			if(engineerid == 0){/*0x6c (OV4688) will be applied under this rule (engineerid == 0)*/
				i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
					dlxp_china_camera_i2c_boardinfo_ov4688_0x6c_ov2722,
					ARRAY_SIZE(dlxp_china_camera_i2c_boardinfo_ov4688_0x6c_ov2722));
			} else {/*0x20 (OV4688) will be applied under this rule (engineerid >= 1)*/
				i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
					dlxp_china_camera_i2c_boardinfo_ov4688_0x20_ov2722,
					ARRAY_SIZE(dlxp_china_camera_i2c_boardinfo_ov4688_0x20_ov2722));
			}
			...
			if (front_camera_id == CAMERA_SENSOR_ID_AR0260_2M) {
				...
				i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
					dlp_china_camera_i2c_boardinfo_imx135_ov2722,
					ARRAY_SIZE(dlp_china_camera_i2c_boardinfo_imx135_ov2722));
			}

			update_yushanII_flag(HTC_CAMERA_IMAGE_NONE_BOARD);
		}
	}
	if(system_rev >= PVT)/*HTC chuck EWS overwrite the ews_enable by sys_rev*/
