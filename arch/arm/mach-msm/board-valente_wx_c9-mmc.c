...
static struct pm8xxx_gpio_init wimax_init_pmgpios[] __initdata = {
	PM8XXX_GPIO_OUTPUT_FOR_WIMAX_STRE_LOW_FOR_WIMAX(VALENTE_WX_C9_V_WIMAX_PVDD_EN, 0),
	PM8XXX_GPIO_OUTPUT_FOR_WIMAX_STRE_LOW_FOR_WIMAX(VALENTE_WX_C9_V_WIMAX_DVDD_EN, 0),
	PM8XXX_GPIO_OUTPUT_FOR_WIMAX_STRE_HIGH_FOR_WIMAX(VALENTE_WX_C9_V_WIMAX_1V2_RF_EN, 0),
	PM8XXX_GPIO_OUTPUT_FOR_WIMAX_STRE_LOW_FOR_WIMAX(VALENTE_WX_C9_WIMAX_SLEEP_CLK, 0),
	PM8XXX_GPIO_INPUT_FOR_WIMAX_FATAL_ERROR(VALENTE_WX_C9_FATAL_ERROR_IND, PM_GPIO_PULL_DN),
};

static struct pm8xxx_gpio_init wimax_pvdd_pmgpios[] = {
	PM8XXX_GPIO_OUTPUT_FOR_WIMAX_STRE_LOW_FOR_WIMAX(VALENTE_WX_C9_V_WIMAX_PVDD_EN, 0),
	PM8XXX_GPIO_OUTPUT_FOR_WIMAX_STRE_LOW_FOR_WIMAX(VALENTE_WX_C9_V_WIMAX_PVDD_EN, 1),
};

static struct pm8xxx_gpio_init wimax_dvdd_pmgpios[] = {
	PM8XXX_GPIO_OUTPUT_FOR_WIMAX_STRE_LOW_FOR_WIMAX(VALENTE_WX_C9_V_WIMAX_DVDD_EN, 0),
	PM8XXX_GPIO_OUTPUT_FOR_WIMAX_STRE_LOW_FOR_WIMAX(VALENTE_WX_C9_V_WIMAX_DVDD_EN, 1),
};

static struct pm8xxx_gpio_init wimax_1v2_pmgpios[] = {
	PM8XXX_GPIO_OUTPUT_FOR_WIMAX_STRE_HIGH_FOR_WIMAX(VALENTE_WX_C9_V_WIMAX_1V2_RF_EN, 0),
	PM8XXX_GPIO_OUTPUT_FOR_WIMAX_STRE_HIGH_FOR_WIMAX(VALENTE_WX_C9_V_WIMAX_1V2_RF_EN, 1),
};

static struct pm8xxx_gpio_init wimax_sleep_clk_pmgpios[] = {
	PM8XXX_GPIO_OUTPUT_FOR_WIMAX_STRE_LOW_FOR_WIMAX(VALENTE_WX_C9_WIMAX_SLEEP_CLK, 0),
	PM8XXX_GPIO_OUTPUT_FOR_WIMAX_FUNC_FOR_WIMAX(VALENTE_WX_C9_WIMAX_SLEEP_CLK, 0, PM_GPIO_FUNC_1),
};
