...
struct msm_gpiomux_config dlxp_wl_ethernet_configs[] = {
/*	{
		.gpio = 43,
		.settings = {
...
#endif
static struct msm_gpiomux_config dlxp_wl_hsic_configs[] = {
	{
		.gpio = 88,               /*HSIC_STROBE */
		.settings = {
...
static struct msm_gpiomux_config dlxp_wl_gsbi_configs[] __initdata = {
	{
...
static struct msm_gpiomux_config dlxp_wl_slimbus_config[] __initdata = {
	{
		.gpio   = 40,           /* slimbus clk */
		.settings = {
...
static struct msm_gpiomux_config dlxp_wl_audio_codec_configs[] __initdata = {
	{
		.gpio = 39,
		.settings = {
...
static struct msm_gpiomux_config dlxp_wl_ext_regulator_configs[] __initdata = {
	{
		.gpio = dlxp_wl_EXT_3P3V_REG_EN_GPIO,
		.settings = {
...
struct msm_gpiomux_config dlxp_wl_rotate_key_config[] = {
	{
		.gpio = 46,
		.settings = {
...
static struct msm_gpiomux_config dlxp_wl_mxt_configs[] __initdata = {
	{	/* TS INTERRUPT */
		.gpio = 6,
		.settings = {
...
#endif
void __init dlxp_wl_init_gpiomux(void)
{
	int rc;
...
#if defined(CONFIG_KS8851) || defined(CONFIG_KS8851_MODULE)
	msm_gpiomux_install(dlxp_wl_ethernet_configs,
			ARRAY_SIZE(dlxp_wl_ethernet_configs));
#endif
#if 0
	msm_gpiomux_install(wcnss_5wire_interface,
			ARRAY_SIZE(wcnss_5wire_interface));
#endif
	msm_gpiomux_install(dlxp_wl_gsbi_configs,
			ARRAY_SIZE(dlxp_wl_gsbi_configs));

	msm_gpiomux_install(dlxp_wl_slimbus_config,
			ARRAY_SIZE(dlxp_wl_slimbus_config));

	msm_gpiomux_install(dlxp_wl_audio_codec_configs,
			ARRAY_SIZE(dlxp_wl_audio_codec_configs));
...
//	msm_gpiomux_install(dlxp_wl_ext_regulator_configs,
//			ARRAY_SIZE(dlxp_wl_ext_regulator_configs));
...
#ifdef CONFIG_USB_EHCI_MSM_HSIC
	msm_gpiomux_install(dlxp_wl_hsic_configs,
		ARRAY_SIZE(dlxp_wl_hsic_configs));
#endif
