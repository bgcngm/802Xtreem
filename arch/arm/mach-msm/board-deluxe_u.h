...
#ifndef __ARCH_ARM_MACH_MSM_BOARD_DELUXE_U_H
#define __ARCH_ARM_MACH_MSM_BOARD_DELUXE_U_H
...
int __init deluxe_u_init_keypad(void);
...
#define I2S_WS_L			GPIO(27)
#define AUD_CPU_RX_I2S_SCK	GPIO(28)
#define AUD_CPU_TX_I2S_SD	GPIO(29)
...
#define AUD_FM_I2S_SYNC1	GPIO(36)
#define AUD_FM_I2S_SYNC2	GPIO(37)
...
#define POGO_ID				PMGPIO(21)
#define NC_PMGPIO_22		PMGPIO(22)
#define CAM_ID_XB			PMGPIO(22)
#define BT_WAKE				PMGPIO(23)
#define GREEN_BACK_LED		PMGPIO(24)
#define AMBER_BACK_LED		PMGPIO(25)
...
extern int deluxe_u_pm8921_regulator_pdata_len __devinitdata;
...
extern struct rpm_regulator_platform_data
	deluxe_u_rpm_regulator_pdata __devinitdata;

extern struct regulator_init_data deluxe_u_saw_regulator_pdata_8921_s5;
extern struct regulator_init_data deluxe_u_saw_regulator_pdata_8921_s6;
extern struct regulator_init_data deluxe_u_saw_regulator_pdata_8821_s0;
extern struct regulator_init_data deluxe_u_saw_regulator_pdata_8821_s1;

struct mmc_platform_data;
int __init apq8064_add_sdcc(unsigned int controller,
		struct mmc_platform_data *plat);

void deluxe_u_init_mmc(void);
int deluxe_u_wifi_init(void);
void deluxe_u_init_gpiomux(void);
void deluxe_u_init_pmic(void);

#if 1	// for pre-evt no camera
extern struct platform_device deluxe_u_msm_rawchip_device;
#endif
extern struct msm_camera_board_info deluxe_u_camera_board_info;
void deluxe_u_init_cam(void);

#define APQ_8064_GSBI1_QUP_I2C_BUS_ID 0
#define APQ_8064_GSBI3_QUP_I2C_BUS_ID 3
#define APQ_8064_GSBI4_QUP_I2C_BUS_ID 4

void deluxe_u_init_fb(void);
void deluxe_u_allocate_fb_region(void);
void deluxe_u_mdp_writeback(struct memtype_reserve *reserve_table);

void deluxe_u_init_gpu(void);
void deluxe_u_pm8xxx_gpio_mpp_init(void);
void deluxe_u_usb_uart_switch(int nvbus);
