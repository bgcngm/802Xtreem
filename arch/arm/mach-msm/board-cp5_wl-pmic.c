...
static const struct pm8xxx_adc_map_pt cp5_wl_adcmap_btm_threshold[] = {
	{-200,	1671},
	{-190,	1663},
	{-180,	1654},
	{-170,	1646},
...
static const struct pm8xxx_adc_map_pt cp5_wl_sprint_adcmap_btm_threshold[] = {
	{-200,	1670},
	{-190,	1662},
	{-180,	1654},
	{-170,	1645},
...
static struct pm8xxx_adc_map_table pm8xxx_adcmap_btm_table = {
	.table = cp5_wl_adcmap_btm_threshold,
	.size = ARRAY_SIZE(cp5_wl_adcmap_btm_threshold),
};
...
static int __init check_cid_setup(char *str)
{
	if (!strncmp(str, "SPCS", 4)) {
		pm8xxx_adcmap_btm_table.table
			= cp5_wl_sprint_adcmap_btm_threshold;
		pm8xxx_adcmap_btm_table.size
			= ARRAY_SIZE(cp5_wl_sprint_adcmap_btm_threshold);
	}
	return 1;
}
