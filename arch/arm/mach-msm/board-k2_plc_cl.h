...
#define	GPIO(X)		(X)
#ifndef __ARCH_ARM_MACH_MSM_BOARD_K2_PLC_CL_H
#define __ARCH_ARM_MACH_MSM_BOARD_K2_PLC_CL_H
/* EVM GPIO */
/* XA GPIO */
...
int __init k2_plc_cl_gpiomux_init(void);
...
int __init k2_plc_cl_init_mmc(void);
