...
static struct msm_i2c_platform_data msm_gsbi8_qup_i2c_pdata = {
	.clk_freq = 100000,
	.src_clk_rate = 24000000,
#ifdef CONFIG_MSM8X60_AUDIO // HTC_AUD_START
	.clk = "gsbi_qup_clk",
	.pclk = "gsbi_pclk",
#endif // HTC_AUD_END
	.msm_i2c_config_gpio = gsbi_qup_i2c_gpio_config,
...
#endif
#ifdef CONFIG_SERIAL_MSM_HS //CONFIG_BT
	&msm_device_uart_dm1,
#endif
#ifdef CONFIG_BT
	&villec2_rfkill,
...
/* MIC_BIAS2 is configured as headset MIC BIAS */
...
#ifndef CONFIG_MSM8X60_AUDIO // HTC_AUD_START
...
static int hdmi_enable_5v(int on)
{
/*Internal 5v is provided from battery in 8x60 */
#if 0
...
static void __init msm8x60_init(struct msm_board_data *board_data)
{
	...
	msm_auxpcm_init(); // HTC_AUD_
	msm_snddev_init();
	villec2_audio_init(); // HTC_AUD_
#endif
#if defined(CONFIG_GPIO_SX150X) || defined(CONFIG_GPIO_SX150X_MODULE)
