...
dlxp_wl_gpio_regulator_pdata[] __devinitdata = {
	...
	//	  dlxp_wl_EXT_3P3V_REG_EN_GPIO, NULL),
...
struct regulator_init_data dlxp_wl_saw_regulator_pdata_8921_s5 =
	/*	      ID  vreg_name	       min_uV   max_uV */
	SAW_VREG_INIT(S5, "8921_s5",	       850000, 1300000);
struct regulator_init_data dlxp_wl_saw_regulator_pdata_8921_s6 =
	SAW_VREG_INIT(S6, "8921_s6",	       850000, 1300000);

struct regulator_init_data dlxp_wl_saw_regulator_pdata_8821_s0 =
	/*	      ID       vreg_name	min_uV  max_uV */
	SAW_VREG_INIT(8821_S0, "8821_s0",       850000, 1300000);
struct regulator_init_data dlxp_wl_saw_regulator_pdata_8821_s1 =
...
dlxp_wl_rpm_regulator_init_data[] __devinitdata = {
...
int dlxp_wl_pm8921_regulator_pdata_len __devinitdata =
	ARRAY_SIZE(dlxp_wl_pm8921_regulator_pdata);

struct rpm_regulator_platform_data dlxp_wl_rpm_regulator_pdata __devinitdata = {
	.init_data		= dlxp_wl_rpm_regulator_init_data,
	.num_regulators		= ARRAY_SIZE(dlxp_wl_rpm_regulator_init_data),
