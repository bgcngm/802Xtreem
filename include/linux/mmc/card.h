...
#define MMC_HS200_MAX_DTR	200000000
	...
	unsigned char		fwrev[7];			/* SanDisk eMMC firmware version */
...
#define MMC_STATE_NEED_SANITIZE		(1<<13)		/* card need to do SANITIZE */
#define MMC_STATE_DOING_SANITIZE	(1<<14)		/* card is doing SANITIZE */
...
#define MMC_POWERED_ON			1
	...
	s8			speed_class; /* SD card class level */
